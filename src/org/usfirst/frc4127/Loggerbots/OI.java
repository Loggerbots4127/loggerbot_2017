...
public class OI {
    ...
    public OI() {
        ...
        buttonA = new JoystickButton(moveStick, 0);
        buttonB = new JoystickButton(moveStick, 1);
        buttonX = new JoystickButton(moveStick, 2);
        buttonY = new JoystickButton(moveStick, 3);
